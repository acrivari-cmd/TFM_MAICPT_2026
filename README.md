...
1. Configure `OPENROUTER_API_KEY` no arquivo `.env`.
2. Ajuste `OPENROUTER_MODEL_1`, `OPENROUTER_MODEL_2` e `OPENROUTER_MODEL_3` se quiser trocar os modelos.
...
- `M7-T1.py`: fluxo OpenRouter com dois modelos iniciais e árbitro sob demanda.
